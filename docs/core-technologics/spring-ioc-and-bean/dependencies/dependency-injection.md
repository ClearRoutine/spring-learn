...
# <font style="color:rgb(20, 24, 24);">基于构造函数的依赖注入。</font>
...
[使用 name 进行匹配。](https://www.yuque.com/diqiyexu-vgtwd/kgih55/bgum0ah7crsv6qd1)

# <font style="color:rgb(20, 24, 24);">基于 Setter 方法的依赖注入。</font>
...
# <font style="color:rgb(20, 24, 24);">依赖解析过程。</font>
